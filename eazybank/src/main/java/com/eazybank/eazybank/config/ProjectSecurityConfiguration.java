...
public class ProjectSecurityConfiguration {
	...
	SecurityFilterChain defaulSecurityFilterChain(HttpSecurity http) throws Exception{
		...
		http.sessionManagement(sessionConfig -> sessionConfig.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
				...
				.requiresChannel(rcc -> rcc.anyRequest().requiresInsecure()) // only for http
	...
	public AuthenticationManager authenticationManager(UserDetailsService userDetailsService,
		...
		EazyBankUsernamePwdAuthenticationProvider authenticationProvider =
				new EazyBankUsernamePwdAuthenticationProvider((EazyBankUserDetailsService) userDetailsService, passwordEncoder);
